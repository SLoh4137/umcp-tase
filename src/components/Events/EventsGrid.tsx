...
// Hooks
import useEvents, { EventFilterFunction, EventHookOptions } from "hooks/useEvents"
...
//  amount: number,
type Props = WithStyles<typeof styles> & EventHookOptions & {
...
function EventsGrid(props: Props) {
    const { classes, showDescription = true, tags, filterFunction, amount } = props;
    const eventsWithPhoto = useEvents({ tags: tags, filterFunction: filterFunction, amount: amount });
