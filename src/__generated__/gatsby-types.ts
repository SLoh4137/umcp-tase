...
declare namespace GatsbyTypes {
    ...
    type SitePluginPluginOptions = {
        ...
        readonly ignoreFileExtensions: Maybe<
    ...
    type BioQuery = {
        readonly allMarkdownRemark: {
            readonly edges: ReadonlyArray<{
                readonly node: Pick<MarkdownRemark, "id" | "html"> & {
        ...
        readonly allFile: {
            readonly edges: ReadonlyArray<{
                readonly node: Pick<File, "id" | "relativePath"> & {
                    readonly childImageSharp: Maybe<{
            ...
            readonly edges: ReadonlyArray<{
                readonly node: Pick<MarkdownRemark, "html" | "id"> & {
                    ...
                    readonly frontmatter: Maybe<
                        Pick<
                            MarkdownRemarkFrontmatter,
                            "title" | "tags" | "date" | "category" | "imgsrc"
                        >
                    >
                }
            }>
    ...
    type FooterQuery = {
        readonly site: Maybe<{
            readonly siteMetadata: Maybe<
                Pick<SiteSiteMetadata, "copyright" | "facebook" | "instagram">
            >
        }>
    }
    ...
    type DateFormatQuery = {
        readonly site: Maybe<{
            readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "dateFormat">>
        }>
    }
