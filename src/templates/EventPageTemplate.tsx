...
type Props = { data: GatsbyTypes.EventPageQuery, pageContext: PageContext } & PageProps & WithStyles<typeof styles>;
...
function EventPageTemplate(props: Props) {
  ...
  if (!data.markdownRemark?.frontmatter?.title) throw new Error("Title not provided")
